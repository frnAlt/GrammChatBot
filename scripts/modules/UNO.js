...
exports.UnoEngine = exports.UnoEngineTurn = exports.UnoEnginePlayer = exports.UnoEngineCard = exports.TurnAction = exports.CardType = exports.CardColor = void 0;
var CardColor;
(function (CardColor) {
    CardColor["Red"] = "Red";
    CardColor["Blue"] = "Blue";
...
var TurnAction;
(function (TurnAction) {
    TurnAction["PlayCard"] = "PlayCard";
    TurnAction["DrawCards"] = "DrawCards";
    TurnAction["SayUno"] = "SayUno";
    TurnAction["GameStart"] = "GameStart";
...
exports.UnoEngineCard = UnoEngineCard;
class UnoEnginePlayer {
    userID;
    deck;
    isActive;
    hasSaidUno;
...
exports.UnoEnginePlayer = UnoEnginePlayer;
class UnoEngineTurn {
    turnId;
    action;
    player;
    ...
    success;
    error;
    constructor(action, player, nextPlayer, currentColor, isReverse, turnNumber, success, cardPlayed = null, cardsDrawn = [], wildColorChosen = null, gameEnded = false, error = null) {
    ...
    getName() {
        ...
        switch (this.action) {
            case TurnAction.PlayCard:
                return `${this.player.userID} played ${this.cardPlayed?.getName() || "a card"}`;
            case TurnAction.DrawCards:
                return `${this.player.userID} drew ${this.cardsDrawn.length} card${this.cardsDrawn.length > 1 ? "s" : ""}`;
    ...
    getDescription() {
        ...
        if (!this.success) {
            desc += `${this.player.userID} attempted ${this.action} but failed. ${this.error || "Invalid action."} `;
        }
        else {
            switch (this.action) {
                case TurnAction.PlayCard:
                    desc += `${this.player.userID} played ${this.cardPlayed?.getName()}. `;
                    ...
                    break;
                case TurnAction.DrawCards:
                    desc += `${this.player.userID} drew ${this.cardsDrawn.length} card${this.cardsDrawn.length > 1 ? "s" : ""}. `;
                    break;
                case TurnAction.SayUno:
        ...
        desc += `Current color: ${this.currentColor}. Turn order: ${this.isReverse ? "counterclockwise" : "clockwise"}. `;
...
exports.UnoEngineTurn = UnoEngineTurn;
class UnoEngine {
    players;
    deck;
    discardPile;
    ...
    startGame() {
        ...
        if (this.players.length < 2 || this.gameStarted) {
            return new UnoEngineTurn(TurnAction.GameStart, this.players[this.currentPlayerIndex] || new UnoEnginePlayer("unknown"), this.players[this.currentPlayerIndex] || new UnoEnginePlayer("unknown"), this.currentColor, this.isReverse, this.turnNumber, false, null, [], null, false, this.players.length < 2
        ...
        if (firstCard) {
            ...
            const turn = new UnoEngineTurn(TurnAction.GameStart, this.players[this.currentPlayerIndex], this.players[this.currentPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, true, firstCard);
            this.turnHistory.push(turn);
            return turn;
        }
        return new UnoEngineTurn(TurnAction.GameStart, this.players[this.currentPlayerIndex], this.players[this.currentPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, false, null, [], null, false, "Failed to draw initial card");
    }
    canPlayCard(card) {
    ...
    playCard(player, cardId, wildColor) {
        this.turnNumber++;
        if (this.players[this.currentPlayerIndex] !== player || !this.gameStarted) {
            return new UnoEngineTurn(TurnAction.PlayCard, player, this.players[this.currentPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, false, null, [], wildColor || null, false, !this.gameStarted ? "Game not started" : "Not player's turn");
        }
        const card = player.playCard(cardId, wildColor);
        if (!card || !this.canPlayCard(card)) {
            if (card)
                player.drawCard(card);
            return new UnoEngineTurn(TurnAction.PlayCard, player, this.players[this.currentPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, false, card, [], wildColor || null, false, !card ? "Card not found" : "Invalid card play");
        }
        ...
        nextPlayerIndex = this.calculateNextPlayerIndex();
        const turn = new UnoEngineTurn(TurnAction.PlayCard, player, this.players[nextPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, true, card, [], wildColor || null, gameEnded);
        this.turnHistory.push(turn);
    ...
    drawCards(player, count) {
        this.turnNumber++;
        if (this.players[this.currentPlayerIndex] !== player || !this.gameStarted) {
            return new UnoEngineTurn(TurnAction.DrawCards, player, this.players[this.currentPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, false, null, [], null, false, !this.gameStarted ? "Game not started" : "Not player's turn");
        }
        const drawnCards = [];
        ...
        const turn = new UnoEngineTurn(TurnAction.DrawCards, player, this.players[nextPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, true, null, drawnCards);
        this.turnHistory.push(turn);
        this.currentPlayerIndex = nextPlayerIndex;
        return turn;
    }
    sayUno(player) {
        this.turnNumber++;
        if (this.players[this.currentPlayerIndex] !== player || !this.gameStarted) {
            return new UnoEngineTurn(TurnAction.SayUno, player, this.players[this.currentPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, false, null, [], null, false, !this.gameStarted ? "Game not started" : "Not player's turn");
        }
        const success = player.sayUno();
        const nextPlayerIndex = this.calculateNextPlayerIndex();
        const turn = new UnoEngineTurn(TurnAction.SayUno, player, this.players[nextPlayerIndex], this.currentColor, this.isReverse, this.turnNumber, success, null, [], null, false, success ? null : "Cannot say UNO with more than one card");
        if (success) {
            this.turnHistory.push(turn);
            this.currentPlayerIndex = nextPlayerIndex;
        }
    ...
    calculateNextPlayerIndex() {
        ...
        let nextIndex = (this.currentPlayerIndex + increment + this.players.length) %
            this.players.length;
